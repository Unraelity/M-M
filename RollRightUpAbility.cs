...
public class RollRightUpAbility : RollAbility {

    public RollRightUpAbility(PlayerController playerController, OrientationController orientationController, MovementController movementController, AnimationController animController, float rollDuration, float rollTiles) : base(playerController, orientationController, movementController, animController, rollDuration, rollTiles) {}
